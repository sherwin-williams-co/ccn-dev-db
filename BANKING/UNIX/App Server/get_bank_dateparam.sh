...
SELECT 'DAILY_LOAD_RUNDATE='|| TO_CHAR(BATCH_DATE, 'mm/dd/yyyy') 
FROM BANKING_PARAM
WHERE BATCH_NAME='DAILY_LOAD_RUNDATE';
SELECT  'TICKET_TRACKING_RUNDATE='||TO_CHAR(BATCH_DATE, 'mm/dd/yyyy')
FROM BANKING_PARAM
WHERE BATCH_NAME='TICKET_TRACKING_RUNDATE';
SELECT    'BAG_TRACKING_RUNDATE='||TO_CHAR(BATCH_DATE, 'mm/dd/yyyy')
FROM BANKING_PARAM
WHERE BATCH_NAME='BAG_TRACKING_RUNDATE';
