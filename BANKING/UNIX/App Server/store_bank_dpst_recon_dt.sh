...
#Read Variables
PROC_NAME="BANKING_BATCH_PKG.STORE_BANK_DPST_RECON_DT"
LOGDIR=$HOME/logs
...
BEGIN
:exitCode := 0;
BANKING_BATCH_PKG.STORE_BANK_DPST_RECON_DT(V_RUN_PERIOD,'$SERVER_NAME','$LOGFILEPATH');
Exception
when others then
