...
echo "Processing started for generating UAR.POS file at ${TIME} on ${DATE}"
./SRA11000_generate_files_test.sh
echo "Processing finished for generating UAR.POS file at ${TIME} on ${DATE}"
