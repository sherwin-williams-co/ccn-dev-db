/*
Created  : dxv848 
Modified : nxk927 04/26/2016 inserting into UAR_ACH_DRFTS_EXTRCT_CNTRL_FL table instead of ACH_DRFTS_EXTRCT_CNTRL_FL
*/
DECLARE
    V_LOAD_DATE   DATE:= &1;
...
BEGIN
    ...
    END LOOP;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Total rows inserted UAR_ACH_DRFTS_EXTRCT_CNTRL_FL ' || V_TCOUNT);	
EXCEPTION
    WHEN OTHERS THEN
