...
BEGIN
   --Building the header
   V_CLOB := 'BANK_ACCOUNT_NBR,COST_CENTER_CODE,DEPOSIT_BAG_ORDER_PRIORITY,DEPOSIT_BAG_ORDER_STATUS,DEPOSIT_BAG_ORDER_SEQ_NBR,EFFECTIVE_DATE,EXPIRATION_DATE,LAST_MAINTENANCE_DATE,LAST_MAINT_USER_ID,ORDER_DATE,ARRIVAL_DATE,EXTRACTED_USER_ID '||  UTL_TCP.crlf;
