...
SELECT * FROM BANK_ACCOUNT WHERE BANK_ACCOUNT_NBR IN ('4427267639');
SELECT * FROM BANK_ACCOUNT_FUTURE WHERE BANK_ACCOUNT_NBR IN ('4427267639');
UPDATE BANK_ACCOUNT SET EXPIRATION_DATE = NULL WHERE BANK_ACCOUNT_NBR IN ('4427267639');
UPDATE BANK_ACCOUNT_FUTURE SET EFFECTIVE_DATE = '21-JAN-2015' WHERE BANK_ACCOUNT_NBR IN ('4427267639');
SELECT * FROM BANK_ACCOUNT WHERE BANK_ACCOUNT_NBR IN ('4427267639');
SELECT * FROM BANK_ACCOUNT_FUTURE WHERE BANK_ACCOUNT_NBR IN ('4427267639');

SELECT * FROM MEMBER_BANK_CC_FUTURE WHERE LEAD_STORE_NBR = '701344' AND MEMBER_STORE_NBR = '702670';
UPDATE MEMBER_BANK_CC_FUTURE SET EXPIRATION_DATE = NULL WHERE LEAD_STORE_NBR = '701344' AND MEMBER_STORE_NBR = '702670';
SELECT * FROM MEMBER_BANK_CC_FUTURE WHERE LEAD_STORE_NBR = '701344' AND MEMBER_STORE_NBR = '702670';

SELECT * FROM MEMBER_BANK_CC_FUTURE WHERE MEMBER_STORE_NBR = '2304';
DELETE FROM MEMBER_BANK_CC_FUTURE WHERE MEMBER_STORE_NBR = '2304';

SELECT * FROM MEMBER_BANK_CC WHERE MEMBER_STORE_NBR = '2304';
DELETE FROM MEMBER_BANK_CC WHERE MEMBER_STORE_NBR = '2304';
