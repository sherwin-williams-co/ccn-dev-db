...
DROP TABLE BANK_DEP_BAG_TICK;
  CREATE TABLE BANK_DEP_BAG_TICK 
   (	BANK_ACCOUNT_NBR VARCHAR2(20) NOT NULL ENABLE,
	...
	CONSTRAINT BANK_DEP_BAG_TICK_PK PRIMARY KEY (COST_CENTER_CODE) ENABLE,
	CONSTRAINT BANK_DEP_BAG_TICK_FK FOREIGN KEY (BANK_ACCOUNT_NBR)
