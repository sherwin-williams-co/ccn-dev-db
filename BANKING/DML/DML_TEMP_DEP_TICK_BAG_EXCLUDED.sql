/*
   script name: DML_TEMP_DEP_TICK_BAG_EXCLUDED.sql
   Created by : 03/07/2018 axt754 CCN Project Team...
                This Script Inserts data into TEMP_DEP_TICK_BAG_EXCLUDED table
*/
...
SET SERVEROUTPUT ON;
BEGIN
for rec in (SELECT '701085'as COST_CENTER_CODE , 'LIVONIA' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '32255' as OPEN_DATE from Dual Union
SELECT '701106'as COST_CENTER_CODE , 'BINGHAMTON' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28764' as OPEN_DATE from Dual Union
SELECT '701414'as COST_CENTER_CODE , 'SHERLINK ONLINE PAYMENTS' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '35955' as OPEN_DATE from Dual Union
SELECT '701650'as COST_CENTER_CODE , 'CUYAHOGA FALLS' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28672' as OPEN_DATE from Dual Union
SELECT '701761'as COST_CENTER_CODE , 'ALMA' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '29068' as OPEN_DATE from Dual Union
SELECT '701894'as COST_CENTER_CODE , 'KOKOMO' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28976' as OPEN_DATE from Dual Union
SELECT '702052'as COST_CENTER_CODE , 'COLUMBUS-MIDTOWN' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '29007' as OPEN_DATE from Dual Union
SELECT '702172'as COST_CENTER_CODE , 'ORLANDO-SOUTH' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '30662' as OPEN_DATE from Dual Union
SELECT '702331'as COST_CENTER_CODE , 'MACON-RIVERSIDE' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '29007' as OPEN_DATE from Dual Union
SELECT '702335'as COST_CENTER_CODE , 'BRADENTON-COMMERCIAL' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '36203' as OPEN_DATE from Dual Union
SELECT '702370'as COST_CENTER_CODE , 'OCALA-MAIN' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28976' as OPEN_DATE from Dual Union
SELECT '702372'as COST_CENTER_CODE , 'OCALA-COLLEGE PARK' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '31292' as OPEN_DATE from Dual Union
SELECT '702435'as COST_CENTER_CODE , 'WINTERVILLE F/C CTR' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '37228' as OPEN_DATE from Dual Union
SELECT '702472'as COST_CENTER_CODE , 'ALPHARETTA-WINDWARD' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '38611' as OPEN_DATE from Dual Union
SELECT '702594'as COST_CENTER_CODE , 'SURF CITY' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '39021' as OPEN_DATE from Dual Union
...
SELECT '703072'as COST_CENTER_CODE , 'DICKINSON' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28976' as OPEN_DATE from Dual Union
SELECT '703144'as COST_CENTER_CODE , 'ST LOU - ARNOLD' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '32583' as OPEN_DATE from Dual Union
SELECT '703229'as COST_CENTER_CODE , 'SARTELL' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '36753' as OPEN_DATE from Dual Union
SELECT '703326'as COST_CENTER_CODE , 'WINSTON SALEM' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '38442' as OPEN_DATE from Dual Union
SELECT '705248'as COST_CENTER_CODE , 'ROCHESTER F/C CTR' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '35061' as OPEN_DATE from Dual Union
SELECT '705335'as COST_CENTER_CODE , 'SYOSSET-OYSTER BAY' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '38432' as OPEN_DATE from Dual Union
SELECT '705400'as COST_CENTER_CODE , 'MOUNT CRAWFORD-HARRISBURG F/C CTR' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '40478' as OPEN_DATE from Dual Union
SELECT '705490'as COST_CENTER_CODE , 'EAST HANOVER' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '40800' as OPEN_DATE from Dual Union
SELECT '705797'as COST_CENTER_CODE , 'HOPEWELL' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28887' as OPEN_DATE from Dual Union
SELECT '705931'as COST_CENTER_CODE , 'WAYNESBORO' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28734' as OPEN_DATE from Dual Union
SELECT '707091'as COST_CENTER_CODE , 'INDIANOLA' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28887' as OPEN_DATE from Dual Union
SELECT '707189'as COST_CENTER_CODE , 'DENVER-E EVANS' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '31775' as OPEN_DATE from Dual Union
SELECT '707710'as COST_CENTER_CODE , 'WHARTON' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28703' as OPEN_DATE from Dual Union
SELECT '707717'as COST_CENTER_CODE , 'PARIS' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '28642' as OPEN_DATE from Dual Union
SELECT '707763'as COST_CENTER_CODE , 'AMORY' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '39944' as OPEN_DATE from Dual Union
SELECT '708003'as COST_CENTER_CODE , 'TUCSON-BROADWAY' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '31775' as OPEN_DATE from Dual Union
SELECT '708070'as COST_CENTER_CODE , 'SAN FRANCISCO-4TH ST' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '32142' as OPEN_DATE from Dual Union
SELECT '708164'as COST_CENTER_CODE , 'TORRANCE' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '33595' as OPEN_DATE from Dual Union
SELECT '708226'as COST_CENTER_CODE , 'LAS VEGAS F/C CTR' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '35258' as OPEN_DATE from Dual Union
...
SELECT '799162'as COST_CENTER_CODE , 'AUTO CHERRY HILL' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '39419' as OPEN_DATE from Dual Union
SELECT '799325'as COST_CENTER_CODE , 'AUTO CHARLESTON' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '38930' as OPEN_DATE from Dual Union
SELECT '799701'as COST_CENTER_CODE , 'AUTO FT COLLINS' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '39302' as OPEN_DATE from Dual Union
SELECT '799748'as COST_CENTER_CODE , 'AUTO GRAND PRAIRIE' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '38930' as OPEN_DATE from Dual Union
SELECT '799752'as COST_CENTER_CODE , 'AUTO MESQUITE' as COST_CENTER_NAME , 'P' as POLLING_STATUS_CODE , 'S' as CATEGORY , 'USA' as COUNTRY_CODE , '39693' as OPEN_DATE from Dual
) LOOP

    INSERT INTO TEMP_DEP_TICK_BAG_EXCLUDED VALUES(rec.COST_CENTER_CODE, rec.COST_CENTER_NAME, rec.POLLING_STATUS_CODE, rec.CATEGORY, rec.COUNTRY_CODE, rec.OPEN_DATE);
END LOOP;
-- Commit the complete transaction
COMMIT;
END;
/
SELECT * FROM TEMP_DEP_TICK_BAG_EXCLUDED;