   ...
   FOR REC IN TEMP_CUR LOOP
      BEGIN
         ...
         IF V_TEMP_ROW.TRANSACTION_TYPE = 'DEPOSIT'  THEN
            ...
            V_CREDIT_ROW.TRANSACTION_SQ_ID        := REC.TRANSACTION_SQ_ID;
            ...
            FOR rec1 IN (SELECT *
                ...
                CUSTOMER_DEPOSIT_MAINT_PKG.ORIG_DEP_REM_BAL_UPD(GET_CSTMR_DPST_SALES_LN_ITM_AMT(rec1.CUSTOMER_ACCOUNT_NUMBER, rec1.COST_CENTER_CODE,rec1.TRANSACTION_NUMBER,rec1.TERMINAL_NUMBER,rec1.TRANSACTION_DATE),
         ...
         ELSIF V_TEMP_ROW.TRANSACTION_TYPE = 'REDEMPTION' THEN
               ...
               V_REDEMPTION_ROW.TRANSACTION_SQ_ID              := REC.TRANSACTION_SQ_ID;
