...
CREATE INDEX CUST_DEP_TRANS_DTL_IND ON CUSTOMER_DEPOSIT_TRANSACTION_DTL (COST_CENTER_CODE, TERMINAL_NUMBER, TRANSACTION_NUMBER,TRANSACTION_DATE, CUSTOMER_ACCOUNT_NUMBER);
