...
ALTER TABLE CUSTOMER_DEPOSIT_DETAILS 
    DROP CONSTRAINT CUSTOMER_DEPOSIT_DETAILS_PK;
...
-- Create Index on CUST_DEP_CREDIT_DETAILS 
...
-- Create Index on CUST_DEP_REDEMPTION_DETAILS
...
-- Create Index on CUSTOMER_DEPOSIT_DETAILS

CREATE INDEX CUSTOMER_DEPOSIT_DETAILS_INDE2  ON CUSTOMER_DEPOSIT_DETAILS(COST_CENTER_CODE, TRANSACTION_DATE, TERMINAL_NUMBER, TRANSACTION_NUMBER, CUSTOMER_ACCOUNT_NUMBER);
