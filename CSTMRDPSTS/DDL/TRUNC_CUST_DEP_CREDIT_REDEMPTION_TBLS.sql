...
CREATE TABLE CUST_DEP_CREDIT_DETAILS_BKUP AS SELECT * FROM CUST_DEP_CREDIT_DETAILS;
CREATE TABLE CUST_DEP_REDEMPTION_DETAILS_BKUP AS SELECT * FROM CUST_DEP_REDEMPTION_DETAILS;
--Truncating tables
