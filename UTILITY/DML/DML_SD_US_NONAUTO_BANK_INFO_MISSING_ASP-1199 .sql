...
SET DEFINE OFF;
Insert into MAILING_GROUP (GROUP_ID,MAIL_ID) values ('129','pmmalloy@sherwin.com;jeklodnick@sherwin.com;ccnoracle.team@sherwin.com');
...
values ('SD_US_NONAUTO_BANK_INFO_MISSING',
        '129',
        'Store Drafts US NON Auto Bank missing Payee Information Report',
