...
SET DEFINE OFF;
Insert into MAILING_GROUP (GROUP_ID,MAIL_ID) values ('122','ccnoracle.team@sherwin.com');
...
Insert into MAILING_FILE_DETAILS (FILE_ID,GROUP_ID,FILE_NAME,DIRECTORY_NAME,IS_ACTIVE) values (2,'122','PRIMESUB_DETAILS_FAIL','CCN_DATAFILES','A');
