/*
Created : nxk927 05/04/2018
          This script will load the drafts that errored out on 05/04/2018
          Check serial numbers '0284566536','0284566577','0284566569','0284566551','0284566502','0284566528','0284566585'

*/
INSERT INTO HST_STORE_DRAFTS
   SELECT * FROM STORE_DRAFTS WHERE CHECK_SERIAL_NUMBER IN ('0284566536','0284566577','0284566569','0284566551','0284566502','0284566528','0284566585');
INSERT INTO HST_STORE_DRAFTS_DETAIL
   SELECT * FROM STORE_DRAFTS_DETAIL WHERE CHECK_SERIAL_NUMBER IN ('0284566536','0284566577','0284566569','0284566551','0284566502','0284566528','0284566585');

DELETE FROM STORE_DRAFTS_DETAIL WHERE CHECK_SERIAL_NUMBER IN ('0284566536','0284566577','0284566569','0284566551','0284566502','0284566528','0284566585');
DELETE FROM STORE_DRAFTS WHERE CHECK_SERIAL_NUMBER IN ('0284566536','0284566577','0284566569','0284566551','0284566502','0284566528','0284566585');
COMMIT;


DECLARE
IN_DATE DATE :=TRUNC(SYSDATE)-2;
    CURSOR STOREDRAFT_TEMP_CUR is
        SELECT ICD.*, (SELECT COST_CENTER_CODE 
         ...
         WHERE CHECK_SERIAL_NUMBER IN ('0284566536','0284566577','0284566569','0284566551','0284566502','0284566528','0284566585');
...
BEGIN
    ...
    FOR rec IN STOREDRAFT_TEMP_CUR LOOP
        BEGIN
            ...
            V_STOREDRAFT_TEMP_ROW.LOAD_DATE      := TO_DATE('05-MAY-2018 06:30:00','DD-MON-YYYY HH24:MI:SS');
          ...
          FROM DLY_POS_ISSUE_CHANGE_DATA B,
               (SELECT TRANGUID,
                 ...
                 WHERE LOAD_DATE > IN_DATE
                   AND CHECK_SERIAL_NUMBER IN ('0284566536','0284566577','0284566569','0284566551','0284566502','0284566528','0284566585')
                 UNION ALL
                SELECT TRANGUID,
                       TRANSACTION_SOURCE,
                       TRANSACTION_TYPE,
                ...
                SELECT TRANGUID,
                 ...
                 WHERE LOAD_DATE > IN_DATE
                   AND CHECK_SERIAL_NUMBER IN ('0284566536','0284566577','0284566569','0284566551','0284566502','0284566528','0284566585')) A
