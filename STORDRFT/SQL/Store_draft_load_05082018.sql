/*
Created : nxk927 05/08/2018
          This script will load the draft that errored out on Tuesday. ( CHECK_SERIAL_NUMBER '0164814063')

*/

INSERT INTO HST_STORE_DRAFTS
   SELECT * FROM STORE_DRAFTS WHERE CHECK_SERIAL_NUMBER = '0164814063';
INSERT INTO HST_STORE_DRAFTS_DETAIL
   SELECT * FROM STORE_DRAFTS_DETAIL WHERE CHECK_SERIAL_NUMBER = '0164814063';

DELETE FROM STORE_DRAFTS_DETAIL WHERE CHECK_SERIAL_NUMBER = '0164814063';
DELETE FROM STORE_DRAFTS WHERE CHECK_SERIAL_NUMBER = '0164814063';
COMMIT;
/


DECLARE
IN_DATE DATE :=TRUNC(SYSDATE)-1;
    CURSOR STOREDRAFT_TEMP_CUR is
        SELECT ICD.*, (SELECT COST_CENTER_CODE 
         ...
         WHERE CHECK_SERIAL_NUMBER = '0164814063' ;
...
BEGIN
    ...
    FOR rec IN STOREDRAFT_TEMP_CUR LOOP
        BEGIN
            ...
            V_STOREDRAFT_TEMP_ROW.LOAD_DATE      := TO_DATE('09-MAY-2018 06:30:00','DD-MON-YYYY HH24:MI:SS');
          ...
          FROM DLY_POS_ISSUE_CHANGE_DATA B,
               (SELECT TRANGUID,
                 ...
                 WHERE LOAD_DATE > IN_DATE
                   AND CHECK_SERIAL_NUMBER = '0164814063'
                 UNION ALL
                SELECT TRANGUID,
                       TRANSACTION_SOURCE,
                       TRANSACTION_TYPE,
                ...
                SELECT TRANGUID,
                 ...
                 WHERE LOAD_DATE > IN_DATE
                   AND CHECK_SERIAL_NUMBER = '0164814063') A
