...
------------------------------------------*/
  CREATE TABLE STORDRFT.SD_CHECK_NBR_PRNT_EXTRCT_DTLS 
  ...
  CREATE TABLE STORDRFT.SD_CHECK_NBR_RUN_TYPE_PRNT_DTLS 
  ...
  CREATE TABLE STORDRFT.SD_CHECK_NBR_TRCKNG_DTLS 
   (COST_CENTER_CODE           VARCHAR2(6), 
	CHKS_ORDERED_DATE          DATE, 
  ...
  CREATE TABLE STORDRFT.STORE_RUN_TYP_THRSHLD_DTLS 
   (COST_CENTER_CODE              VARCHAR2(6 ), 
	STORE_DRAFT_CHECK_RUN_TYPE    VARCHAR2(1 ), 
	EFFECTIVE_DATE                DATE, 
	EXPIRATION_DATE               DATE, 
