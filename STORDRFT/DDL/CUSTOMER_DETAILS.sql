  ...
  CREATE TABLE CUSTOMER_DETAILS 
   (	CUSTOMER_DETAIL_ID NUMBER(15,0) NOT NULL ENABLE, 
	...
	CONSTRAINT CUSTOMER_DETAILS_FK FOREIGN KEY (COST_CENTER_CODE, TRANSACTION_DATE, TERMINAL_NUMBER, TRANSACTION_NUMBER) REFERENCES CUSTOMER (COST_CENTER_CODE, TRANSACTION_DATE, TERMINAL_NUMBER, TRANSACTION_NUMBER) ENABLE
   );

  CREATE INDEX CUSTOMER_DETAILS_IDX ON CUSTOMER_DETAILS (COST_CENTER_CODE, TRANSACTION_DATE, TERMINAL_NUMBER, TRANSACTION_NUMBER);
