CREATE TABLE "STORDRFT"."CUSTOMER_DETAILS" 
   (	"CUSTOMER_DETAIL_ID" NUMBER(15,0) NOT NULL ENABLE, 
	...
	"ORGNL_POS_TRANS_NUMBER" VARCHAR2(5 CHAR), 
	 CONSTRAINT "CUSTOMER_DETAILS_PK" PRIMARY KEY ("CUSTOMER_DETAIL_ID", "COST_CENTER_CODE", "TRANSACTION_DATE", "TERMINAL_NUMBER", "TRANSACTION_NUMBER")
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE INDEX "STORDRFT"."CUSTOMER_DETAILS_IDX" ON "STORDRFT"."CUSTOMER_DETAILS" ("COST_CENTER_CODE", "TRANSACTION_DATE", "TERMINAL_NUMBER", "TRANSACTION_NUMBER") 
