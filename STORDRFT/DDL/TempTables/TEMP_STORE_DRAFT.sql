BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE TEMP_STORE_DRAFT';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/

CREATE TABLE TEMP_STORE_DRAFT 
   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ACCESS PARAMETERS
      ( RECORDS FIXED 335
        badfile STORDRFT_LOAD_FILES:'TEMP_STORE_DRAFT.bad'
        logfile STORDRFT_LOAD_FILES:'TEMP_STORE_DRAFT.log'
        discardfile STORDRFT_LOAD_FILES:'TEMP_STORE_DRAFT.dsc'
          FIELDS
