BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE DLY_CUSTOMER_LINE_ITEM_DATA';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/

  CREATE TABLE DLY_CUSTOMER_LINE_ITEM_DATA 
   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ( RECORDS DELIMITED BY NEWLINE
        badfile STORDRFT_LOAD_FILES:'DLY_CUSTOMER_LINE_ITEM_DATA.bad'
        logfile STORDRFT_LOAD_FILES:'DLY_CUSTOMER_LINE_ITEM_DATA.log'
        discardfile STORDRFT_LOAD_FILES:'DLY_CUSTOMER_LINE_ITEM_DATA.dsc'
        LOAD WHEN ((40:40) = 'K')
        FIELDS(
