...
DECLARE
    ...
    SELECT * 
     ...
     WHERE CHECK_SERIAL_NUMBER IN (SELECT CHECK_SERIAL_NUMBER 
                                     FROM UNATTACHED_MNL_DRFT_DTL_HST)
       AND TERMINAL_NUMBER IS NULL;
...
BEGIN
    ...
    FOR rec IN STOREDRAFT_CLNUP_CUR
    LOOP
        ...
        BEGIN
            ...
            DELETE UNATTACHED_MNL_DRFT_DTL_HST
