#!/bin/sh
#################################################################
# Script name   : DMD_US_AM_FTP_ARCH_LOG.sh
#
# Description   : This script is to run the FTP, Archiving and Logging for daily Automotive US Maintenance files
#
...
proc_name="DMD_US_AM_FTP_ARCH_LOG"
proc_name1="DMD_US_AM_FTP_ARCH"
LOGDIR=$HOME/dailyLoad/logs
TIME=`date +"%H:%M:%S"`
DATE=${DAILY_LOAD_RUNDATE}
TimeStamp=`date '+%Y%m%d%H%M%S'`
FILE_NAME=DLY_MAINT_DRAFT_US_AM
