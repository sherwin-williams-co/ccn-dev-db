...
if 
    ...
    find -maxdepth 1 -name STORE_DRAFT_\*.TXT -exec mv {} $ARCHIVE_PATH/"dailyLoad"_"$P2" \; > /dev/null 2>&1
else
...
if 
    ...
    find -maxdepth 1 -name CUSTOMER_LABOR_\*.TXT -exec mv {} $ARCHIVE_PATH/"dailyLoad"_"$P2" \; > /dev/null 2>&1
else
