#!/bin/sh
#################################################################
# Script name   : DD_CAN_NAM_FTP_ARCH_LOG.sh
#
# Description   : This script is to run the FTP, Archiving and Logging for daily Non Automotive Canada issue files
#
...
#            added if condition to check for the file if it is present or not and the size of the file is 18 bytes if its empty
#################################################################
# below command will get the path for stordrft.config respective to the environment from which it is run from
. /app/stordrft/host.sh

proc_name="DD_CAN_NAM_FTP_ARCH_LOG"
