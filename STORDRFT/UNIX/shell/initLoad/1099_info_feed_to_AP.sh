...
set heading off;
set verify off;
execute SD_FILE_BUILD_PKG.SD_1099_NO_MTCHD_VENDOR_RPRT(to_date('$DATE1','MM/DD/YYYY'));
execute SD_FILE_BUILD_PKG.SD_1099_MTCHD_PRCSNG_RPRT(to_date('$DATE1','MM/DD/YYYY'));
execute SD_FILE_BUILD_PKG.SD_1099_NO_VNDR_ON_BNK_TP_RPRT(to_date('$DATE1','MM/DD/YYYY'));
