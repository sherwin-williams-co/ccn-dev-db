#!/bin/sh
#################################################################
# Script name   : SRA11000_Arch_SRA10510.sh
#
# Description   : This shell script will perform below tasks
#                 1. archieve the SRA10510 file in it's corresponding folder
#
...
proc_name="SRA11000_Arch_SRA10510"
