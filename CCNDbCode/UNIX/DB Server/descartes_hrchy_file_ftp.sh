#!/bin/sh
#################################################################
# Script name   : descartes_hrchy_file_ftp.sh
#
...
proc_name="descartes_hrchy_file_ftp"
...
cd "$descartes_folder"
put $file tmpDESCARTES_HRCHY_FEED_$DT.ZZCCN.ZZDESCARTES
rename tmpDESCARTES_HRCHY_FEED_$DT.ZZCCN.ZZDESCARTES DESCARTES_HRCHY_FEED_$DT.ZZCCN.ZZDESCARTES
bye
END_SCRIPT
