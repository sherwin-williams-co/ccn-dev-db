#!/bin/sh
###############################################################################################################################
# Script name   : generate_descartes_hrchy_file.sh
#
...
proc="generate_descartes_hrchy_file"
...
execute CCN_BATCH_PROCESS.GENERATE_DESCARTES_HRCHY_FILE;
...
then
   ...
   cd $HOME/
   ./send_mail.sh DESCARTES_HRCHY_FILE_ERROR "$logfile"
