...
BEGIN
    POS_DATA_GENERATION.SET_FLAG_POLLING_BULK_LOADS('BULK_STORE_DESG_TML_NBR_LOAD', V_BULK_LOAD_LKUP_ID);
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        -- Logging of error
        errpkg.raise_err(SQLCODE, substr(SQLERRM,1, 500) ||'  BULK_STORE_DESG_TML_NBR_LOAD '  || ' errors found');
END;