  CREATE OR REPLACE VIEW FACTS_DIVISION_DETAIL_VIEW ("STATEMENT_TYPE","HRCHY_HDR_NAME","COST_CENTER_CODE","HRCHY_DTL_EFF_DATE","HRCHY_DTL_EXP_DATE","DOMAIN","GROUP","DIVISION","DOMAIN_NAME","GROUP_NAME","DIVISION_NAME","COST_CENTER_NAME") AS 
