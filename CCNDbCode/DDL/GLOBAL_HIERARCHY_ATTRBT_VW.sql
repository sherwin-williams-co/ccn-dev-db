...
*******************************************************************************/
       ...
       GV.COST_CENTER_NAME,
       COMMON_TOOLS.RETURN_EMPLOYEE_NAME(CCN_HIERARCHY.GET_RQSTD_ATTRIBUTE_VALUE(COMMON_TOOLS.GET_UPPER_LVL_VER_VALUE ( GV.HRCHY_HDR_NAME, GV.DOMAIN, GV.DOMAIN||GV."GROUP", '~~~' ), 'ManagerName'))DOMAIN_MGR_NAME,
       COMMON_TOOLS.RETURN_EMPLOYEE_NAME(CCN_HIERARCHY.GET_RQSTD_ATTRIBUTE_VALUE(COMMON_TOOLS.GET_UPPER_LVL_VER_VALUE ( GV.HRCHY_HDR_NAME, GV.DOMAIN||GV."GROUP", GV.DOMAIN||GV."GROUP"||GV.DIVISION, GV.DOMAIN ), 'ManagerName'))GROUP_MGR_NAME,
       COMMON_TOOLS.RETURN_EMPLOYEE_NAME(CCN_HIERARCHY.GET_RQSTD_ATTRIBUTE_VALUE(COMMON_TOOLS.GET_UPPER_LVL_VER_VALUE ( GV.HRCHY_HDR_NAME, GV.DOMAIN||GV."GROUP"||GV.DIVISION, GV.DOMAIN||GV."GROUP"||GV.DIVISION||GV.AREA, GV.DOMAIN||GV."GROUP" ), 'ManagerName'))DIV_MGR_NAME,
       COMMON_TOOLS.RETURN_EMPLOYEE_NAME(CCN_HIERARCHY.GET_RQSTD_ATTRIBUTE_VALUE(COMMON_TOOLS.GET_UPPER_LVL_VER_VALUE ( GV.HRCHY_HDR_NAME, GV.DOMAIN||GV."GROUP"||GV.DIVISION||GV.AREA, GV.DOMAIN||GV."GROUP"||GV.DIVISION||GV.AREA||GV.DISTRICT, GV.DOMAIN||GV."GROUP"||GV.DIVISION ), 'ManagerName'))AREA_MGR_NAME,
       COMMON_TOOLS.RETURN_EMPLOYEE_NAME(CCN_HIERARCHY.GET_RQSTD_ATTRIBUTE_VALUE(COMMON_TOOLS.GET_UPPER_LVL_VER_VALUE ( GV.HRCHY_HDR_NAME, GV.DOMAIN||GV."GROUP"||GV.DIVISION||GV.AREA||GV.DISTRICT, GV.DOMAIN||GV."GROUP"||GV.DIVISION||GV.AREA||GV.DISTRICT||GV.CITY_SALES_MANAGER, GV.DOMAIN||GV."GROUP"||GV.DIVISION||GV.AREA ), 'ManagerName'))DISTRICT_MGR_NAME,
