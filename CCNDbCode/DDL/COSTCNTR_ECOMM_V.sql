...
*******************************************************************************/
    ...
    -- added swp in front of STORE_EMAIL otherwise add sw in front of STORE_EMAIL
        ...
        ,CCN_COMMON_TOOLS.GET_COST_CENTER_DSC_CODES(SUBSTR(c.COST_CENTER_CODE,3),'PRIMARY_DSC')   AS PRIMARY_DSC 
        ,CCN_COMMON_TOOLS.GET_COST_CENTER_DSC_CODES(SUBSTR(c.COST_CENTER_CODE,3),'SECONDARY_DSC') AS ALTERNATE_DSC
    FROM COST_CENTER C,
