...
Modified : 08/18/2015 nxk927 CCN Project...
         ...
         : 07/24/2017 axt754 CCN Project Team....
           Added fields CURRENCY_CODE, GL_DIVISION to the view.
*******************************************************************************/
        (CASE C.CATEGORY
    ...
    -- added swp in front of STORE_EMAIL otherwise add sw in front of STORE_EMAIL
        ...
        ,C.CURRENCY_CODE
        ,NVL((SELECT LEGACY_DIVISION
                FROM LEGACY_GL_DIVISION_DETAIL_VIEW
               WHERE COST_CENTER_CODE = C.COST_CENTER_CODE),'N/A') GL_DIVISION
    FROM COST_CENTER C,
