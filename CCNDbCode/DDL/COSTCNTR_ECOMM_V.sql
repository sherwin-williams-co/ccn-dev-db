  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "COSTCNTR"."COSTCNTR_ECOMM_V" ("SALES_REP_NAME", "SALES_REP_NUMBER", "STORE_NUMBER", "STORE_NAME", "STATEMENT_TYPE", "STATEMENT_TYPE_DESCRIPTION", "ADDRESS1", "ADDRESS2", "CITY", "STATE", "STATE_DESCRIPTION", "ZIP", "ZIP_CODE_4", "COUNTY_NAME", "COUNTRY", "COUNTRY_DESCRIPTION", "PHONE_NUMBER", "FAX_NUMBER", "FIRST_NAME", "MIDDLE_INITIAL", "LAST_NAME", "OPEN_DATE", "CLOSE_DATE", "STORE_EMAIL", "REAL_ESTATE_TYPE", "MISSION_CODE", "MISSION_CODE_DESCRIPTION", "STORE_TYPE", "DAD", "DIVISION", "AREA", "DISTRICT", "DIVISION_NAME", "AREA_NAME", "DISTRICT_NAME", "CITY_MANAGER_NAME", "DISTRICT_MANAGER_NAME", "ACTIVE_CD", "POLLING_STATUS_CODE", "POLLING_STATUS_CODE_DESCRIPTON", "TW_STATE_CODE", "TW_ZIPCODE", "TW_GEO_CODE", "TW_COUNTRY", "TW_COMPANY", "FIPS_ST", "FIPS_COUNTY", "FIPS_CITY", "TYPE_CODE", "TYPE_CODE_DESCRIPTION", "INVENTORY_INDICATOR", "PERP_INV_START_DATE", "COUNTRY_CODE_TWO_DIGIT", "PRIMARY_DSC", "ALTERNATE_DSC", "PCC_STORE", "PCL_STORE", "CC_TEMP_CLOSED_CODE", "CC_TEMP_CLOSED_CODE_DESCRIPTION") AS 
  SELECT
/*******************************************************************************
...
Modified : 08/18/2015 nxk927 CCN Project...
		 ...
		 : 08/26/2019 axm868 CCN Project Team....
     	   Added CC_TEMP_CLOSED_CODE AND CC_TEMP_CLOSED_CODE_DESCRIPTION Fields  CCNCC-171
*******************************************************************************/
        (CASE C.CATEGORY
    ...
    -- added swp in front of STORE_EMAIL otherwise add sw in front of STORE_EMAIL
        ...
        ,NVL(CCN_PICK_LIST_PKG.GET_CODE_DETAIL_VALUE_DSCRPTN('CC_TEMP_CLOSED_CD','COD',C.CC_TEMP_CLOSED_CD),'N/A') CC_TEMP_CLOSED_CODE_DESCRIPTION
    FROM COST_CENTER C,
