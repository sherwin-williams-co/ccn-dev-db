...
*******************************************************************************/
    ...
    -- added swp in front of STORE_EMAIL otherwise add sw in front of STORE_EMAIL
        ...
        ,(SELECT PRIMARY_DSC FROM COST_CENTER_DSC_CODES DSC WHERE SUBSTR(c.COST_CENTER_CODE,3) = DSC.COST_CENTER_CODE) AS PRIMARY_DSC
        ,(SELECT SECONDARY_DSC FROM COST_CENTER_DSC_CODES DSC  WHERE SUBSTR(c.COST_CENTER_CODE,3) = DSC.COST_CENTER_CODE) AS ALTERNATE_DSC
    FROM COST_CENTER C,
