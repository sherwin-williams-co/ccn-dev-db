...
ORGANIZATION EXTERNAL(
  ...
  CREATE TABLE "COSTCNTR"."COST_CENTER_COPY" 
   (	"COST_CENTER_CODE_OLD" VARCHAR2(6 BYTE), 
	"COST_CENTER_CODE_NEW" VARCHAR2(6 BYTE)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "CCN_LOAD_FILES"
      ACCESS PARAMETERS
      ( RECORDS DELIMITED BY NEWLINE SKIP 1 
       badfile "CCN_LOAD_FILES":'COST_CENTER_COPY.bad' 
       logfile "CCN_LOAD_FILES":'COST_CENTER_COPY.log' 
       FIELDS TERMINATED BY ',' 
       OPTIONALLY ENCLOSED BY '"' 
       LDRTRIM MISSING FIELD VALUES ARE NULL
       REJECT ROWS WITH ALL NULL FIELDS
       (COST_CENTER_CODE_OLD,COST_CENTER_CODE_NEW)
              )
      LOCATION
  ...
  CREATE TABLE "COSTCNTR"."COST_CENTER_HIERARCHY" 
   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ACCESS PARAMETERS
      ( RECORDS DELIMITED BY NEWLINE SKIP 1 
      badfile "CCN_LOAD_FILES":'COST_CENTER_HIERARCHY.bad' 
      logfile "CCN_LOAD_FILES":'COST_CENTER_HIERARCHY.log' 
      FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' 
      LDRTRIM MISSING FIELD VALUES ARE NULL
      REJECT ROWS WITH ALL NULL FIELDS
      (COST_CENTER_CODE ,MANAGER_ID,
  ...
  CREATE TABLE "COSTCNTR"."COST_CENTER_HIERARCHY_TRNSFR" 
   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ACCESS PARAMETERS
      ( RECORDS DELIMITED BY NEWLINE SKIP 1 
      badfile "CCN_LOAD_FILES":'COST_CENTER_HIERARCHY_TRNSFR.bad' 
      logfile "CCN_LOAD_FILES":'COST_CENTER_HIERARCHY_TRNSFR.log' 
      FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' 
      LDRTRIM MISSING FIELD VALUES ARE NULL
      REJECT ROWS WITH ALL NULL FIELDS
      (COST_CENTER_CODE ,MANAGER_ID,
  ...
  CREATE TABLE "COSTCNTR"."COST_CENTER_POLLING" 
   (	"COST_CENTER_CODE" VARCHAR2(6 BYTE), 
	"MERCHANT_ID" VARCHAR2(20 BYTE), 
	"DISCOVER_ID" VARCHAR2(20 BYTE), 
	"AMEX_ID" VARCHAR2(20 BYTE), 
	"POLLING_STATUS" VARCHAR2(1 BYTE), 
	"OPEN_DATE" VARCHAR2(8 BYTE)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ACCESS PARAMETERS
      ( RECORDS DELIMITED BY NEWLINE SKIP 1 
      badfile "CCN_LOAD_FILES":'COST_CENTER_POLLING.bad' 
      logfile "CCN_LOAD_FILES":'COST_CENTER_POLLING.log' 
      FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' 
      LDRTRIM MISSING FIELD VALUES ARE NULL
      REJECT ROWS WITH ALL NULL FIELDS
      (COST_CENTER_CODE ,MERCHANT_ID,DISCOVER_ID,AMEX_ID,POLLING_STATUS,OPEN_DATE)
          )
      LOCATION
       ( 'COST_CENTER_POLLING.csv'
       )
    )
   REJECT LIMIT UNLIMITED;
