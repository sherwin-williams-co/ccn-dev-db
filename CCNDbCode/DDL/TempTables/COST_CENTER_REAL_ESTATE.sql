/*
Script Name: COST_CENTER_REAL_ESTATE.sql
Purpose    : For dropping and creating the COST_CENTER_REAL_ESTATE table.
             This is an external table which is used for storing data from COST_CENTER_REAL_ESTATE.csv
