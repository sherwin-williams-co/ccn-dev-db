...
WITH ALL NULL FIELDS (COST_CENTER_CODE, COST_CENTER_NAME, CATEGORY, ENTITY_TYPE
   ...
   TERRITORY_CATEGORY, LEASE_CAR_INDICATOR, TERRITORY_TYPE_BUSN_CODE,TERRITORY_TYP_OF_BUSN_SGMNT_CD,
   ...
   MANAGER_ID,POS_NON_STORE_IND) ) LOCATION ( 'COST_CENTER_TERRITORY.csv' )
   )
