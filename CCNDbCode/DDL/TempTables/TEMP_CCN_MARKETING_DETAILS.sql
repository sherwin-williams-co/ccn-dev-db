/*
Below external table is used to pull the marketing details from the file provided by users

Created : 11/11/2016 jxc517 CCN Project Team....
*/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE TEMP_CCN_MARKETING_DETAILS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/

  CREATE TABLE TEMP_CCN_MARKETING_DETAILS 
   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ( RECORDS DELIMITED BY NEWLINE
        BADFILE CCN_LOAD_FILES:'TEMP_CCN_MARKETING_DETAILS.bad'
        LOGFILE CCN_LOAD_FILES:'TEMP_CCN_MARKETING_DETAILS.log'
        DISCARDFILE CCN_LOAD_FILES:'TEMP_CCN_MARKETING_DETAILS.dsc'
        SKIP 0
        FIELDS
        (
