...
SELECT CC.COST_CENTER_CODE,
                ...
                FROM COST_CENTER CC,
                    (SELECT ADDRESS_LINE_1, ADDRESS_LINE_2, ADDRESS_LINE_3, COST_CENTER_CODE FROM ADDRESS_USA WHERE ADDRESS_TYPE = 'M' AND EXPIRATION_DATE IS NULL
                      UNION ALL
                     SELECT ADDRESS_LINE_1, ADDRESS_LINE_2, ADDRESS_LINE_3, COST_CENTER_CODE FROM ADDRESS_CAN WHERE ADDRESS_TYPE = 'M' AND EXPIRATION_DATE IS NULL
                      UNION ALL
                     SELECT ADDRESS_LINE_1, ADDRESS_LINE_2, ADDRESS_LINE_3, COST_CENTER_CODE FROM ADDRESS_MEX WHERE ADDRESS_TYPE = 'M' AND EXPIRATION_DATE IS NULL
                      UNION ALL
                     SELECT ADDRESS_LINE_1, ADDRESS_LINE_2, ADDRESS_LINE_3, COST_CENTER_CODE FROM ADDRESS_OTHER WHERE ADDRESS_TYPE = 'M' AND EXPIRATION_DATE IS NULL) ADDRESS
