...
(SELECT TERRITORY_TYPE_BUSN_CODE 
  FROM  TERRITORY T 
 WHERE T.COST_CENTER_CODE=C.COST_CENTER_CODE
  AND  T.CATEGORY='T')TERRITORY_TYPE_BUSN_CODE,
NVL((SELECT CD.CODE_DETAIL_DESCRIPTION
       FROM CODE_DETAIL CD,
            TERRITORY T
      WHERE CD.CODE_DETAIL_VALUE=T.TERRITORY_TYPE_BUSN_CODE
       AND  CD.CODE_HEADER_NAME='TERRITORY_TYPE_BUSN_CODE'
       AND  T.CATEGORY='T'
       AND  T.COST_CENTER_CODE=C.COST_CENTER_CODE),'N/A') TERRITORY_TYPE_BUSN_CODE_DESC
FROM COST_CENTER C;