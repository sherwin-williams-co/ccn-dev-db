  ...
  CREATE OR REPLACE FORCE VIEW "COSTCNTR"."COST_CENTER_VW" ("COST_CENTER_CODE", "COST_CENTER_NAME", "CATEGORY", "CATEGORY_DESCRIPTION", "STATEMENT_TYPE", "STATEMENT_TYPE_DESCRIPTION", "COUNTRY_CODE", "COUNTRY_CODE_DESCRIPTION", "BEGIN_DATE", "OPEN_DATE", "MOVE_DATE", "CLOSE_DATE", "CURRENCY_CODE", "MISSION_TYPE_CODE", "MISSION_TYPE_CODE_DESCRIPTION", "DUNS_NUMBER", "ACQUISITION_CODE", "PRI_LOGO_GROUP_IND", "PRI_LOGO_GROUP_IND_DESCRIPTION", "SCD_LOGO_GROUP_IND", "SCD_LOGO_GROUP_IND_DESCRIPTION", "COLOR_CONSULTANT_TYPE", "PCC_PCL_STORE", "FAX_PHONE_NUMBER", "TYPE_CODE", "STATUS_CODE", "POLLING_IND", "POLLING_START_DATE", "POLLING_STOP_DATE", "POLLING_STATUS_CODE", "POLLING_STATUS_COD_DESC", "TERR_HOME_STORE_NO", "FIRST_NAME", "MIDDLE_INITIAL", "LAST_NAME", "ADMIN_COST_CNTR_TYPE", "TERRITORY_TYPE_BUSN_CODE", "TERRITORY_TYPE_BUSN_CODE_DESC", "STD_COST_IDENTIFIER", "PRIM_COST_IDENTIFIER", "INVENTORY_INDICATOR", "PERP_INV_START_DATE", "RURAL_METRO_ZONE_CODE", "TYPE_CODE_DESCRIPTION", "STORE_EMAIL", "BOOK_PLN_PROFILE_CD", "SPRAY_EQP_RPR_IND", "CLASSIFICATION_CODE", "CLASSIFICATION_CODE_DESC", "SELLING_STORE_FLAG", "POP_KIT_CODE", "POP_KIT_CODE_DESC", "SALES_VOL_CLASS_CODE", "SALES_VOL_CLASS_CODE_DESC", "LONGITUDE", "LATITUDE","DIVISION","Leasing_Sales_Sq_Ft","Leasing_Total_Sq_Ft","LEASE_OR_OWNED") AS 
  SELECT
/*******************************************************************************
...
SWC.DIVISION,
SWC.Leasing_Sales_Sq_Ft,
SWC.Leasing_Total_Sq_Ft,
SWC.LEASE_OR_OWNED 
...
LEFT JOIN
(SELECT DIVISION,Leasing_Sales_Sq_Ft,Leasing_Total_Sq_Ft,LEASE_OR_OWNED,COST_CENTER FROM CCN_SWC_PN_SQFT_INT) SWC
ON (SWC.COST_CENTER=C.COST_CENTER_CODE )
;
