...
NVL(CCN_PICK_LIST_PKG.GET_CODE_DETAIL_VALUE_DSCRPTN('TERRITORY_TYP_OF_BUSN_SGMNT_CD','COD',T.TERRITORY_TYP_OF_BUSN_SGMNT_CD),'N/A')TERR_TYP_OF_BUSN_SGMNT_CD_DESC,
STD_COST_IDENTIFIER,
