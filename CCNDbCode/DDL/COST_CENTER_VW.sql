...
Modified : 02/17/2015 SXT410 Added FAX_PHONE_NUMBER, POLLING_STATUS_CODE and
         ...
         : 03/20/2018 rxv940 Added LAT and LON columns to the view
********************************************************************************/  
C.COST_CENTER_CODE,
COST_CENTER_NAME,
C.CATEGORY,
...
CCN_COMMON_TOOLS.GET_ADDRESS_GEO(C.COST_CENTER_CODE, 'LON') LON,
CCN_COMMON_TOOLS.GET_ADDRESS_GEO(C.COST_CENTER_CODE, 'LAT') LAT
